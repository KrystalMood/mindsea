<article
    class="group relative overflow-hidden rounded-2xl border-4 border-{{ $color }}-200 bg-white p-6 shadow-lg transition-all hover:shadow-xl">
    ...
    <!-- Audio Description -->
    <button onclick="window.SpeakText('{{ $title }}. {{ $description }}')"
