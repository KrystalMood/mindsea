  ...
  return (
    <main className="bg-background relative flex flex-col items-center justify-center px-4 pt-40 pb-20 text-center">
      <section className="decoration-wrapper pointer-events-none absolute inset-0 z-0">
        <div className="bg-primary/10 absolute -top-24 -left-24 h-75 w-75 rounded-full blur-3xl" />
        <div className="bg-accent/20 absolute -right-36 -bottom-36 hidden h-100 w-100 rounded-full blur-3xl lg:inline" />
        <div className="bg-tertiary/10 absolute top-12 left-1/2 h-50 w-50 -translate-x-1/2 rounded-full blur-2xl" />
      ...
      <div className="relative z-10 w-full max-w-2xl cursor-default">
        ...
        <section className="mb-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <Link href="" className="border-primary text-primary hover:bg-primary group flex items-center justify-center gap-3 rounded-lg border-2 px-6 py-3.5 text-xs font-semibold transition-all duration-300 hover:text-white lg:text-sm">
