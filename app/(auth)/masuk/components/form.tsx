  ...
  return (
    <section className="mx-auto flex w-17/20 flex-col justify-center gap-8 lg:w-1/2 lg:px-[7.5%]">
      <div className="flex items-center gap-5">
        ...
        <Image src="/images/mascot.png" alt="Logo Mindsea" width={40} height={40} className="h-12 w-auto object-contain" priority />
      </div>
      ...
      <form className="flex flex-col gap-5" method="POST" onSubmit={(e: ChangeEvent<HTMLFormElement>) => submit(e)}>
